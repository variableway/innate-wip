  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-[#8FA68E]">
            <PenLine className="h-4 w-4 text-white" />
          </div>
          {!collapsed && !mobile && (
            <span className="text-sm font-semibold">Innate</span>
          )}
        </Link>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto py-3">
          ...
          >
            ...
            {!collapsed && (
              <>
                ...
                <ChevronRight className={cn("h-3 w-3 transition-transform", contentOpen && "rotate-90")} />
              </>
            )}
          </button>
          ...
          {makingOpen && !collapsed && (
            <div className="ml-2 mt-0.5 space-y-0.5">
              <Link
                ...
                className={cn(
                  "flex items-center gap-2.5 rounded-lg px-2.5 py-1.5 text-sm transition-all",
                  pathname === "/making/projects" || pathname.startsWith("/making/projects/")
                    ? "bg-[#8FA68E]/10 text-[#6b856a] dark:text-[#a8c4a7] font-semibold"
                    : "text-muted-foreground hover:bg-secondary/70 hover:text-foreground"
                )}
              >
              ...
              <Link
                ...
                className={cn(
                  "flex items-center gap-2.5 rounded-lg px-2.5 py-1.5 text-sm transition-all",
                  pathname === "/making/weekly" || pathname.startsWith("/making/weekly/")
                    ? "bg-[#8FA68E]/10 text-[#6b856a] dark:text-[#a8c4a7] font-semibold"
                    : "text-muted-foreground hover:bg-secondary/70 hover:text-foreground"
                )}
              >
              ...
              <Link
                ...
                className={cn(
                  "flex items-center gap-2.5 rounded-lg px-2.5 py-1.5 text-sm transition-all",
                  pathname === "/making/insights" || pathname.startsWith("/making/insights/")
                    ? "bg-[#8FA68E]/10 text-[#6b856a] dark:text-[#a8c4a7] font-semibold"
                    : "text-muted-foreground hover:bg-secondary/70 hover:text-foreground"
                )}
              >
              ...
              <Link
                ...
                className={cn(
                  "flex items-center gap-2.5 rounded-lg px-2.5 py-1.5 text-sm transition-all",
                  pathname === "/making/issues" || pathname.startsWith("/making/issues/")
                    ? "bg-[#8FA68E]/10 text-[#6b856a] dark:text-[#a8c4a7] font-semibold"
                    : "text-muted-foreground hover:bg-secondary/70 hover:text-foreground"
                )}
              >
        ...
        <div className="px-2 mb-2">
          <button
            ...
            className={cn(
              "flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm transition-all w-full text-left",
              (isAwesomeRoot || pathname.startsWith("/awesome/"))
                ? "bg-[#8FA68E]/10 text-[#6b856a] dark:text-[#a8c4a7] font-semibold"
                : "text-muted-foreground hover:bg-secondary/70 hover:text-foreground",
              collapsed && "justify-center px-0"
            )}
          ...
          >
            ...
            {!collapsed && (
              <>
                ...
                <ChevronRight className={cn("h-3 w-3 transition-transform", awesomeOpen && "rotate-90")} />
              </>
            )}
          </button>
      ...
      <div className="shrink-0 border-t border-border p-2 space-y-0.5">
        {!collapsed && (
          <button
            ...
            className="flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm text-muted-foreground hover:bg-secondary/70 hover:text-foreground transition-colors w-full"
          >
        ...
        {collapsed && (
          <a
            ...
            className={cn(
              "flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm text-muted-foreground hover:bg-secondary/70 hover:text-foreground transition-colors",
              collapsed && "justify-center px-0"
            )}
            title="RSS Feed"
          >
        ...
        {rssOpen && !collapsed && (
          <div className="ml-2 space-y-0.5">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2.5 rounded-lg px-2.5 py-1.5 text-sm text-muted-foreground hover:bg-secondary/70 hover:text-foreground transition-colors"
            >
    ...
    return (
      <>
        <button
          ...
          className="fixed left-4 top-3 z-50 flex h-8 w-8 items-center justify-center rounded-lg border border-border/60 bg-card/90 backdrop-blur text-muted-foreground shadow-sm hover:text-foreground transition-colors md:hidden"
